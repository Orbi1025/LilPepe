import { a as h, f as b, o as w, r as g, x as r } from "./index-BFBnHLNB.js";
import { n as o, c as v, o as p } from "./if-defined-ByrZyKqn.js";
...
var t = function (u, a, e, s) {
  var l = arguments.length,
    n =
      l < 3 ? a : s === null ? (s = Object.getOwnPropertyDescriptor(a, e)) : s,
    c;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    n = Reflect.decorate(u, a, e, s);
  else
    for (var d = u.length - 1; d >= 0; d--)
      (c = u[d]) && (n = (l < 3 ? c(n) : l > 3 ? c(a, e, n) : c(a, e)) || n);
...
let i = class extends g {
  ...
  visualTemplate() {
    ...
    if (this.variant === "icon" && this.icon && this.iconVariant) {
      const a = ["blue", "square-blue"].includes(this.iconVariant)
          ? "accent-100"
          : "fg-200",
