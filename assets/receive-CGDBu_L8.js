...
var b = function (n, e, i, t) {
  var o = arguments.length,
    r =
      o < 3 ? e : t === null ? (t = Object.getOwnPropertyDescriptor(e, i)) : t,
    s;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    r = Reflect.decorate(n, e, i, t);
  else
    for (var a = n.length - 1; a >= 0; a--)
      (s = n[a]) && (r = (o < 3 ? s(r) : o > 3 ? s(e, i, r) : s(e, i)) || r);
    ...
    return u` <wui-flex class="networks">
      ${
        e == null
          ...
          : e.map(
              (i) =>
                u` <wui-flex class="network-icon"> <wui-image src=${i}></wui-image> </wui-flex>`
            )
      }
    </wui-flex>`;
  }
...
p.styles = [A, R, E];
b([N({ type: Array })], p.prototype, "networkImages", void 0);
b([N()], p.prototype, "text", void 0);
p = b([$("wui-compatible-network")], p);
const W = k`
...
let l = class extends C {
  ...
  networkTemplate() {
    ...
    if (
      ((a = this.preferredAccountTypes) == null
        ? void 0
    ...
    const s = (
      (y =
        o == null
          ...
          : o.filter((c) => {
              var v;
              return (v = c == null ? void 0 : c.assets) == null
                ? void 0
                : v.imageId;
            })) == null
        ? void 0
  ...
  onCopyClick() {
    try {
      this.address &&
        (S.copyToClopboard(this.address), h.showSuccess("Address copied"));
    } catch {
...
l.styles = W;
w([f()], l.prototype, "address", void 0);
w([f()], l.prototype, "profileName", void 0);
w([f()], l.prototype, "network", void 0);
w([f()], l.prototype, "preferredAccountTypes", void 0);
l = w([$("w3m-wallet-receive-view")], l);
export { l as W3mWalletReceiveView };
