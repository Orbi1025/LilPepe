...
import { n as F, r as c, c as k, o as v } from "./if-defined-ByrZyKqn.js";
import { O as I } from "./index-CzQOYnTW.js";
import { e as M } from "./index-DHxEdJlO.js";
...
`;
var w = function (a, e, i, o) {
  var n = arguments.length,
    t =
      n < 3 ? e : o === null ? (o = Object.getOwnPropertyDescriptor(e, i)) : o,
    r;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    t = Reflect.decorate(a, e, i, o);
  else
    for (var s = a.length - 1; s >= 0; s--)
      (r = a[s]) && (t = (n < 3 ? r(t) : n > 3 ? r(e, i, t) : r(e, i)) || t);
...
let h = class extends L {
  ...
  async handlePwaFrameLoad() {
    ...
    if (C.isPWA()) {
      this.isPwaLoading = !0;
      try {
        ((e = this.authConnector) == null ? void 0 : e.provider) instanceof D &&
...
$.styles = V;
A([c()], $.prototype, "checked", void 0);
$ = A([k("w3m-connect-socials-view")], $);
const G = E`
  wui-logo {
    width: 80px;
    height: 80px;
    ...
    super(),
      ...
      (this.handleSocialConnection = async (i) => {
        ...
        if ((o = i.data) != null && o.resultUri)
          if (i.origin === q.SECURE_SITE_ORIGIN) {
            ...
            try {
              if (this.authConnector && !this.connecting) {
                ...
                this.socialProvider &&
                  ...
                  await this.authConnector.provider.connectSocial(n),
                  this.socialProvider &&
                    (T.setConnectedSocialProvider(this.socialProvider),
                    await U.connectExternal(
                      this.authConnector,
      ...
      z.EmbeddedWalletAbortController.signal.addEventListener("abort", () => {
        this.socialWindow &&
          (this.socialWindow.close(),
          d.setSocialWindow(void 0, _.state.activeChain));
      }),
      this.unsubscribe.push(
        d.subscribe((i) => {
          i.socialProvider && (this.socialProvider = i.socialProvider),
            ...
            i.address && (O.state.open || b.state.enableEmbedded) && O.close();
        })
      ),
...
p = m([k("w3m-connecting-social-view")], p);
const B = E`
  @keyframes fadein {
    from {
      opacity: 0;
...
let f = class extends L {
  ...
  platformTemplate() {
    return C.isMobile()
      ? l`${this.mobileTemplate()}`
      : l`${this.desktopTemplate()}`;
  }
  desktopTemplate() {
    return this.loading
      ? l`${this.loadingTemplate()}`
      : l`${this.qrTemplate()}`;
  }
  qrTemplate() {
    return l` <wui-flex
  ...
  async connectFarcaster() {
    ...
    if (this.authConnector)
      try {
        await ((e = this.authConnector) == null
          ? void 0
          : e.provider.connectFarcaster()),
          this.socialProvider &&
            (T.setConnectedSocialProvider(this.socialProvider),
            u.sendEvent({
              type: "track",
...
f = x([k("w3m-connecting-farcaster-view")], f);
export {
