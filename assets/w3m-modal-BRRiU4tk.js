...
x.styles = [U, pe];
T([u()], x.prototype, "message", void 0);
T([u()], x.prototype, "backgroundColor", void 0);
T([u()], x.prototype, "iconColor", void 0);
T([u()], x.prototype, "icon", void 0);
x = T([y("wui-alertbar")], x);
const he = b`
  :host {
    display: block;
    position: absolute;
...
let _ = class extends v {
  ...
  render() {
    const { message: e, variant: t } = P.state,
      i = we[t];
    return l`
      <wui-alertbar
        message=${e}
...
_.styles = he;
Q([d()], _.prototype, "open", void 0);
_ = Q([y("w3m-alertbar")], _);
const me = b`
  button {
    display: block;
    display: flex;
...
B.styles = [U, oe, ie, me];
Z([u()], B.prototype, "imageSrc", void 0);
B = Z([y("wui-select")], B);
const fe = b`
  :host {
    height: 64px;
...
function H() {
  var a, r, $, C, W, E, O;
  const s =
      (r = (a = c.state.data) == null ? void 0 : a.connector) == null
        ? void 0
        : r.name,
    e =
      (C = ($ = c.state.data) == null ? void 0 : $.wallet) == null
        ? void 0
        : C.name,
    t =
      (E = (W = c.state.data) == null ? void 0 : W.network) == null
        ? void 0
        : E.name,
    i = e ?? s,
    n = z.getConnectors();
  return {
    ...
    ConnectingSocial: q.state.socialProvider
...
let h = class extends v {
  constructor() {
    super(),
      ...
      (this.viewDirection = ""),
      (this.headerText = H()[c.state.view]),
      this.unsubscribe.push(
        ne.subscribeNetworkImages(() => {
          this.networkImage = L.getNetworkImage(this.network);
        }),
        c.subscribeKey("view", (e) => {
          setTimeout(() => {
            (this.view = e), (this.headerText = H()[e]);
          }, D.ANIMATION_DURATIONS.HeaderText),
            this.onViewChange(),
  ...
  onWalletHelp() {
    G.sendEvent({ type: "track", event: "CLICK_WALLET_HELP" }),
      c.push("WhatIsAWallet");
  }
  async onClose() {
    c.state.view === "UnsupportedChain" || (await K.isSIWXCloseDisabled())
      ? p.shake()
      : p.close(!0);
  }
  rightHeaderTemplate() {
    ...
    const e =
      (n =
        (i = (t = A) == null ? void 0 : t.state) == null
          ? void 0
          : i.features) == null
        ? void 0
        : n.smartSessions;
  ...
  leftHeaderTemplate() {
    ...
    const { view: e } = c.state,
      t = e === "Connect",
      i = A.state.enableEmbedded,
      n = e === "ApproveTransaction",
      o = e === "ConnectingSiwe",
      a = e === "Account",
      r = A.state.enableNetworkSwitch,
      $ = n || o || (t && i);
    return a && r
      ? l`<wui-select
        id="dynamic"
  ...
  onNetworks() {
    this.isAllowedNetworkSwitch() &&
      (G.sendEvent({ type: "track", event: "CLICK_NETWORKS" }),
      c.push("Networks"));
  }
  ...
  onViewChange() {
    ...
    let t = D.VIEW_DIRECTION.Next;
    e.length < this.prevHistoryLength && (t = D.VIEW_DIRECTION.Prev),
...
h.styles = fe;
g([d()], h.prototype, "heading", void 0);
g([d()], h.prototype, "network", void 0);
g([d()], h.prototype, "networkImage", void 0);
g([d()], h.prototype, "showBack", void 0);
g([d()], h.prototype, "prevHistoryLength", void 0);
g([d()], h.prototype, "view", void 0);
g([d()], h.prototype, "viewDirection", void 0);
g([d()], h.prototype, "headerText", void 0);
h = g([y("w3m-header")], h);
const be = b`
  :host {
    display: flex;
...
m.styles = [U, be];
k([u()], m.prototype, "backgroundColor", void 0);
k([u()], m.prototype, "iconColor", void 0);
k([u()], m.prototype, "icon", void 0);
k([u()], m.prototype, "message", void 0);
k([u()], m.prototype, "loading", void 0);
k([u()], m.prototype, "iconType", void 0);
m = k([y("wui-snackbar")], m);
const ve = b`
  :host {
    display: block;
    position: absolute;
    ...
    clearTimeout(this.timeout),
      this.open
        ? (this.animate(
          ...
          N.state.autoClose &&
            (this.timeout = setTimeout(() => N.hide(), 2500)))
        : this.animate(
            [
              { opacity: 1, transform: "translateX(-50%) scale(1)" },
              { opacity: 0, transform: "translateX(-50%) scale(0.85)" },
...
j.styles = ve;
J([d()], j.prototype, "open", void 0);
j = J([y("w3m-snackbar")], j);
const Ce = b`
  :host {
...
let f = class extends v {
  constructor() {
    super(),
      ...
      (this.enableEmbedded = A.state.enableEmbedded),
      (this.open = p.state.open),
      ...
      this.unsubscribe.push(
        ...
        A.subscribeKey("enableEmbedded", (e) => (this.enableEmbedded = e)),
  ...
  initializeTheming() {
    const { themeVariables: e, themeMode: t } = ce.state,
      i = le.getColorTheme(t);
    ae(e, i);
  }
  onClose() {
    (this.open = !1),
  ...
  async onNewAddress(e) {
    ...
    !i && !t ? p.close() : t && i && c.goBack(),
      await K.initializeIfEnabled(),
      (this.caipAddress = e),
  ...
  onNewNetwork(e) {
    ...
    const t = this.caipNetwork,
      i =
        (V = t == null ? void 0 : t.caipNetworkId) == null
          ? void 0
          : V.toString(),
      ...
      r = i !== o,
      C = r && !(n !== a),
      W = (t == null ? void 0 : t.name) === re.UNSUPPORTED_NETWORK_NAME,
  ...
  prefetch() {
    this.hasPrefetched ||
      (R.prefetch(),
      R.fetchWalletsByPage({ page: 1 }),
      (this.hasPrefetched = !0));
  }
};
f.styles = Ce;
S([u({ type: Boolean })], f.prototype, "enableEmbedded", void 0);
S([d()], f.prototype, "open", void 0);
S([d()], f.prototype, "caipAddress", void 0);
S([d()], f.prototype, "caipNetwork", void 0);
S([d()], f.prototype, "shake", void 0);
S([d()], f.prototype, "filterByNamespace", void 0);
f = S([y("w3m-modal")], f);
export { f as W3mModal };
