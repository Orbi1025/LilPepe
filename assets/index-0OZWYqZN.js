import { a2 as At, aQ as se, aR as Lt } from "./index-BFBnHLNB.js";
import { D as ke, g as R, h as Te, y as Mt } from "./hooks.module-dNE3f9LZ.js";
function Rt(t) {
  return (
...
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const ue =
...
function rt(t) {
  return typeof t == "string" && (t = Nt(t)), _e(t), t;
}
class Dt {
  clone() {
...
function Ut(t) {
  const e = (s) => t().update(rt(s)).digest(),
    n = t();
  return (
...
function jt(t, e, n, s) {
  ...
  const r = BigInt(32),
    ...
    l = s ? 4 : 0,
    f = s ? 0 : 4;
  t.setUint32(e + l, a, s), t.setUint32(e + f, o, s);
}
const Bt = (t, e, n) => (t & e) ^ (~t & n),
  Wt = (t, e, n) => (t & e) ^ (t & n) ^ (e & n);
class qt extends Dt {
  constructor(e, n, s, r) {
    super(),
      (this.blockLen = e),
  ...
  update(e) {
    ...
    for (let a = 0; a < i; ) {
      ...
      if (o === r) {
        const l = ue(e);
        for (; r <= i - a; a += r) this.process(l, a);
        continue;
      }
  ...
  digestInto(e) {
    Oe(this), Pt(e, this), (this.finished = !0);
    const { buffer: n, view: s, blockLen: r, isLE: i } = this;
    let { pos: a } = this;
    (n[a++] = 128),
      this.buffer.subarray(a).fill(0),
      this.padOffset > r - a && (this.process(s, 0), (a = 0));
    for (let g = a; g < r; g++) n[g] = 0;
    jt(s, r - 8, BigInt(this.length * 8), i), this.process(s, 0);
    const o = ue(e),
      l = this.outputLen;
    if (l % 4) throw new Error("_sha2: outputLen should be aligned to 32bit");
    const f = l / 4,
      m = this.get();
    if (f > m.length) throw new Error("_sha2: outputLen bigger than state");
    for (let g = 0; g < f; g++) o.setUint32(4 * g, m[g], i);
  }
  digest() {
...
class Kt extends qt {
  ...
  get() {
    const { A: e, B: n, C: s, D: r, E: i, F: a, G: o, H: l } = this;
    return [e, n, s, r, i, a, o, l];
  }
  set(e, n, s, r, i, a, o, l) {
    (this.A = e | 0),
      (this.B = n | 0),
  ...
  process(e, n) {
    for (let g = 0; g < 16; g++, n += 4) Y[g] = e.getUint32(n, !1);
    for (let g = 16; g < 64; g++) {
      const u = Y[g - 15],
        d = Y[g - 2],
        h = W(u, 7) ^ W(u, 18) ^ (u >>> 3),
        I = W(d, 17) ^ W(d, 19) ^ (d >>> 10);
      Y[g] = (I + Y[g - 7] + h + Y[g - 16]) | 0;
    }
    let { A: s, B: r, C: i, D: a, E: o, F: l, G: f, H: m } = this;
    for (let g = 0; g < 64; g++) {
      const u = W(o, 6) ^ W(o, 11) ^ W(o, 25),
        d = (m + u + Bt(o, l, f) + Ht[g] + Y[g]) | 0,
        I = ((W(s, 2) ^ W(s, 13) ^ W(s, 22)) + Wt(s, r, i)) | 0;
      (m = f),
        (f = l),
        (l = o),
        (o = (a + d) | 0),
...
const D = {
  ...
  at = "Unspecified error message.",
  Ft = "Unspecified server error.";
function xe(t, e = at) {
  if (t && Number.isInteger(t)) {
    const n = t.toString();
    if (Ee(ve, n)) return ve[n].message;
    if (ot(t)) return Ft;
  }
  return e;
}
...
function Yt(t, { shouldIncludeStack: e = !1 } = {}) {
  const n = {};
  if (
    t &&
    typeof t == "object" &&
    ...
    (n.code = s.code),
      s.message && typeof s.message == "string"
        ...
        : ((n.message = xe(n.code)), (n.data = { originalError: Ne(t) }));
  } else
    (n.code = D.rpc.internal),
      (n.message = De(t, "message") ? t.message : at),
      (n.data = { originalError: Ne(t) });
  return e && (n.stack = De(t, "stack") ? t.stack : void 0), n;
}
function ot(t) {
...
const C = {
  ...
  provider: {
    userRejectedRequest: (t) => X(D.provider.userRejectedRequest, t),
    unauthorized: (t) => X(D.provider.unauthorized, t),
    unsupportedMethod: (t) => X(D.provider.unsupportedMethod, t),
    disconnected: (t) => X(D.provider.disconnected, t),
    chainDisconnected: (t) => X(D.provider.chainDisconnected, t),
    unsupportedChain: (t) => X(D.provider.unsupportedChain, t),
    custom: (t) => {
      if (!t || typeof t != "object" || Array.isArray(t))
        throw new Error(
...
function B(t, e) {
  const [n, s] = ct(e);
  return new dt(t, n || xe(t), s);
}
function X(t, e) {
  const [n, s] = ct(e);
  return new lt(t, n || xe(t), s);
}
function ct(t) {
  if (t) {
...
const ut = /^[0-9]*$/,
  ht = /^[a-f0-9]*$/;
function Z(t) {
  return Ae(crypto.getRandomValues(new Uint8Array(t)));
}
function Ae(t) {
...
function q(t) {
  return Jt(t.toString(10));
}
function J(t) {
  return ae(`0x${BigInt(t).toString(16)}`);
}
function ft(t) {
  return t.startsWith("0x") || t.startsWith("0X");
}
function Le(t) {
  return ft(t) ? t.slice(2) : t;
}
function pt(t) {
  return ft(t) ? `0x${t.slice(2)}` : `0x${t}`;
}
function le(t) {
...
function Qt(t, e = !1) {
  if (typeof t == "string") {
    ...
    if (ht.test(n)) return ae(e ? `0x${n}` : n);
  }
  throw C.rpc.invalidParams(`"${String(t)}" is not a hexadecimal string`);
}
function Me(t, e = !1) {
  let n = Qt(t, !1);
  return n.length % 2 === 1 && (n = ae(`0${n}`)), e ? ae(`0x${n}`) : n;
}
function V(t) {
  if (typeof t == "string") {
    const e = Le(t).toLowerCase();
    if (le(e) && e.length === 40) return $t(pt(e));
  }
  throw C.rpc.invalidParams(`Invalid Ethereum address: ${String(t)}`);
}
function Ie(t) {
  ...
  throw C.rpc.invalidParams(`Not binary data: ${String(t)}`);
}
function re(t) {
  if (typeof t == "number" && Number.isInteger(t)) return K(t);
  if (typeof t == "string") {
    if (ut.test(t)) return K(Number(t));
    if (le(t)) return K(Number(BigInt(Me(t, !0))));
  }
  throw C.rpc.invalidParams(`Not an integer: ${String(t)}`);
}
function te(t) {
  if (t !== null && (typeof t == "bigint" || Xt(t)))
    return BigInt(t.toString(10));
  if (typeof t == "number") return BigInt(re(t));
  if (typeof t == "string") {
    if (ut.test(t)) return BigInt(t);
    if (le(t)) return BigInt(Me(t, !0));
  }
  throw C.rpc.invalidParams(`Not an integer: ${String(t)}`);
}
function Zt(t) {
  ...
  throw C.rpc.invalidParams(`Not a JSON string or an object: ${String(t)}`);
}
function Xt(t) {
...
async function sn(t, { iv: e, cipherText: n }) {
...
async function an(t, e) {
  return JSON.parse(await sn(e, t));
}
const fe = { storageKey: "ownPrivateKey", keyType: "private" },
  pe = { storageKey: "ownPublicKey", keyType: "public" },
  ge = { storageKey: "peerPublicKey", keyType: "public" };
class on {
  constructor() {
    (this.storage = new H("CBWSDK", "SCWKeyManager")),
  ...
  async clear() {
    (this.ownPrivateKey = null),
      ...
      (this.peerPublicKey = null),
      (this.sharedSecret = null),
      this.storage.removeItem(pe.storageKey),
      this.storage.removeItem(fe.storageKey),
      this.storage.removeItem(ge.storageKey);
  }
  async generateKeyPair() {
    const e = await en();
    (this.ownPrivateKey = e.privateKey),
      (this.ownPublicKey = e.publicKey),
      await this.storeKey(fe, e.privateKey),
      await this.storeKey(pe, e.publicKey);
  }
  async loadKeysIfNeeded() {
    if (
      (this.ownPrivateKey === null &&
        (this.ownPrivateKey = await this.loadKey(fe)),
      this.ownPublicKey === null &&
        (this.ownPublicKey = await this.loadKey(pe)),
      (this.ownPrivateKey === null || this.ownPublicKey === null) &&
        (await this.generateKeyPair()),
      this.peerPublicKey === null &&
        (this.peerPublicKey = await this.loadKey(ge)),
      this.sharedSecret === null)
    ) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null) return;
      this.sharedSecret = await tn(this.ownPrivateKey, this.peerPublicKey);
    }
  }
  async loadKey(e) {
    const n = this.storage.getItem(e.storageKey);
    return n ? wt(e.keyType, n) : null;
  }
  async storeKey(e, n) {
  ...
  const n = Object.assign(Object.assign({}, t), {
    ...
    s = await window.fetch(e, {
      ...
      headers: {
        ...
        "X-Cbw-Sdk-Version": oe,
        "X-Cbw-Sdk-Platform": yt,
      },
    }),
...
function ln({ metadata: t, preference: e }) {
  var n, s;
  ...
  if (o != null && o.isCoinbaseBrowser)
    return (
      (s = o.setAppInfo) === null || s === void 0 || s.call(o, r, i, a, e), o
    );
}
function un(t) {
  if (!t || typeof t != "object" || Array.isArray(t))
...
class hn {
  constructor(e) {
    ...
    (this.metadata = e.metadata),
      ...
      (this.keyManager = new on()),
      (this.storage = new H("CBWSDK", "SCWStateManager")),
      (this.accounts =
  ...
  async handshake(e) {
    ...
    const l = await wt("public", o.sender);
    await this.keyManager.setPeerPublicKey(l);
    const m = (await this.decryptResponseMessage(o)).result;
    if ("error" in m) throw m.error;
    switch (e.method) {
      case "eth_requestAccounts": {
        const g = m.value;
        (this.accounts = g),
          this.storage.storeObject(Ue, g),
          (i = this.callback) === null ||
            i === void 0 ||
            i.call(this, "accountsChanged", g);
        break;
      }
    }
  }
  async request(e) {
    ...
    switch (e.method) {
      case "eth_requestAccounts":
        return (
          (n = this.callback) === null ||
            n === void 0 ||
            n.call(this, "connect", { chainId: J(this.chain.id) }),
          this.accounts
        );
      case "eth_accounts":
      ...
      case "wallet_getCapabilities":
        return this.storage.loadObject(We);
  ...
  async sendEncryptedRequest(e) {
    ...
    const s = await rn({ action: e, chainId: this.chain.id }, n),
  ...
  async decryptResponseMessage(e) {
    ...
    if (!i) throw C.provider.unauthorized("Invalid session");
    const a = await an(r.encrypted, i),
      o = (n = a.data) === null || n === void 0 ? void 0 : n.chains;
    if (o) {
      const f = Object.entries(o).map(([m, g]) => ({
        id: Number(m),
        rpcUrl: g,
      }));
      this.storage.storeObject(Be, f), this.updateChain(this.chain.id, f);
    }
    const l = (s = a.data) === null || s === void 0 ? void 0 : s.capabilities;
    return l && this.storage.storeObject(We, l), a;
  }
  updateChain(e, n) {
    var s;
    const r = n ?? this.storage.loadObject(Be),
      i = r == null ? void 0 : r.find((a) => a.id === e);
    return i
      ? (i !== this.chain &&
          ((this.chain = i),
          this.storage.storeObject(je, i),
          (s = this.callback) === null ||
            s === void 0 ||
            s.call(this, "chainChanged", J(i.id))),
        !0)
      : !1;
  }
}
...
function mt() {
  ...
  function n(a, ...o) {
    ...
    if (o.length > 0 && !o.includes(a.length))
      throw new Error(
        "Uint8Array expected of length " + o + ", got length=" + a.length
      );
  }
  function s(a) {
...
function fn() {
  ...
  function n(b, p = !1) {
    return p
      ? { h: Number(b & t), l: Number((b >> e) & t) }
      : { h: Number((b >> e) & t) | 0, l: Number(b & t) | 0 };
  }
  function s(b, p = !1) {
    let c = new Uint32Array(b.length),
      w = new Uint32Array(b.length);
    for (let _ = 0; _ < b.length; _++) {
      const { h: x, l: N } = n(b[_], p);
      [c[_], w[_]] = [x, N];
    }
    return [c, w];
  }
  const r = (b, p) => (BigInt(b >>> 0) << e) | BigInt(p >>> 0);
  E.toBig = r;
  const i = (b, p, c) => b >>> c;
  E.shrSH = i;
  const a = (b, p, c) => (b << (32 - c)) | (p >>> c);
  E.shrSL = a;
  const o = (b, p, c) => (b >>> c) | (p << (32 - c));
  E.rotrSH = o;
  const l = (b, p, c) => (b << (32 - c)) | (p >>> c);
  E.rotrSL = l;
  const f = (b, p, c) => (b << (64 - c)) | (p >>> (c - 32));
  E.rotrBH = f;
  const m = (b, p, c) => (b >>> (c - 32)) | (p << (64 - c));
  E.rotrBL = m;
  const g = (b, p) => p;
  E.rotr32H = g;
  const u = (b, p) => b;
  E.rotr32L = u;
  const d = (b, p, c) => (b << c) | (p >>> (32 - c));
  E.rotlSH = d;
  const h = (b, p, c) => (p << c) | (b >>> (32 - c));
  E.rotlSL = h;
  const I = (b, p, c) => (p << (c - 32)) | (b >>> (64 - c));
  E.rotlBH = I;
  const v = (b, p, c) => (b << (c - 32)) | (p >>> (64 - c));
  E.rotlBL = v;
  function A(b, p, c, w) {
    const _ = (p >>> 0) + (w >>> 0);
    return { h: (b + c + ((_ / 2 ** 32) | 0)) | 0, l: _ | 0 };
  }
  const L = (b, p, c) => (b >>> 0) + (p >>> 0) + (c >>> 0);
  E.add3L = L;
  const P = (b, p, c, w) => (p + c + w + ((b / 2 ** 32) | 0)) | 0;
  E.add3H = P;
  const k = (b, p, c, w) => (b >>> 0) + (p >>> 0) + (c >>> 0) + (w >>> 0);
  E.add4L = k;
  const y = (b, p, c, w, _) => (p + c + w + _ + ((b / 2 ** 32) | 0)) | 0;
  E.add4H = y;
  const S = (b, p, c, w, _) =>
    (b >>> 0) + (p >>> 0) + (c >>> 0) + (w >>> 0) + (_ >>> 0);
  E.add5L = S;
  const M = (b, p, c, w, _, x) => (p + c + w + _ + x + ((b / 2 ** 32) | 0)) | 0;
  E.add5H = M;
  const T = {
    fromBig: n,
    split: s,
      ...
      (function (t) {
        ...
        function s(c) {
          return (
            ...
            (ArrayBuffer.isView(c) && c.constructor.name === "Uint8Array")
          );
        }
        const r = (c) => new Uint8Array(c.buffer, c.byteOffset, c.byteLength);
        t.u8 = r;
        const i = (c) =>
          new Uint32Array(c.buffer, c.byteOffset, Math.floor(c.byteLength / 4));
        t.u32 = i;
        const a = (c) => new DataView(c.buffer, c.byteOffset, c.byteLength);
        t.createView = a;
        const o = (c, w) => (c << (32 - w)) | (c >>> w);
        t.rotr = o;
        const l = (c, w) => (c << w) | ((c >>> (32 - w)) >>> 0);
        (t.rotl = l),
          (t.isLE =
        ...
        const f = (c) =>
          ...
          ((c >>> 24) & 255);
        (t.byteSwap = f),
          (t.byteSwapIfBE = t.isLE ? (c) => c : (c) => (0, t.byteSwap)(c));
        function m(c) {
          for (let w = 0; w < c.length; w++) c[w] = (0, t.byteSwap)(c[w]);
        }
        const g = Array.from({ length: 256 }, (c, w) =>
          w.toString(16).padStart(2, "0")
        );
        function u(c) {
          (0, n.abytes)(c);
          let w = "";
          for (let _ = 0; _ < c.length; _++) w += g[c[_]];
          return w;
        }
        const d = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
        function h(c) {
          if (c >= d._0 && c <= d._9) return c - d._0;
          if (c >= d.A && c <= d.F) return c - (d.A - 10);
          if (c >= d.a && c <= d.f) return c - (d.a - 10);
        }
        function I(c) {
          if (typeof c != "string")
          ...
          if (w % 2)
            throw new Error(
              "hex string expected, got unpadded hex of length " + w
            );
          const x = new Uint8Array(_);
          for (let N = 0, j = 0; N < _; N++, j += 2) {
            const Q = h(c.charCodeAt(j)),
              Pe = h(c.charCodeAt(j + 1));
            if (Q === void 0 || Pe === void 0) {
              const Ct = c[j] + c[j + 1];
              throw new Error(
        ...
        const v = async () => {};
        t.nextTick = v;
        async function A(c, w, _) {
          let x = Date.now();
          for (let N = 0; N < c; N++) {
            _(N);
            const j = Date.now() - x;
            (j >= 0 && j < w) || (await (0, t.nextTick)(), (x += j));
          }
        }
        function L(c) {
          if (typeof c != "string")
        ...
        function P(c) {
          return typeof c == "string" && (c = L(c)), (0, n.abytes)(c), c;
        }
        function k(...c) {
          let w = 0;
          ...
          for (let x = 0, N = 0; x < c.length; x++) {
            const j = c[x];
            _.set(j, N), (N += j.length);
          }
          return _;
        }
        class y {
        ...
        function M(c) {
          const w = (x) => c().update(P(x)).digest(),
            _ = c();
          return (
            (w.outputLen = _.outputLen),
            (w.blockLen = _.blockLen),
            (w.create = () => c()),
            w
          );
        }
        function T(c) {
          const w = (x, N) => c(N).update(P(x)).digest(),
            _ = c({});
          return (
            (w.outputLen = _.outputLen),
            (w.blockLen = _.blockLen),
...
function bn() {
  ...
  const t = mt(),
    ...
    m = BigInt(256),
    g = BigInt(113);
  for (let k = 0, y = o, S = 1, M = 0; k < 24; k++) {
    ([S, M] = [M, (2 * S + 3 * M) % 5]),
      s.push(2 * (5 * M + S)),
      r.push((((k + 1) * (k + 2)) / 2) % 64);
    let T = a;
    for (let b = 0; b < 7; b++)
      (y = ((y << o) ^ ((y >> f) * g)) % m),
        y & l && (T ^= o << ((o << BigInt(b)) - o));
    i.push(T);
  }
  const [u, d] = (0, e.split)(i, !0),
    h = (k, y, S) => (S > 32 ? (0, e.rotlBH)(k, y, S) : (0, e.rotlSH)(k, y, S)),
    I = (k, y, S) => (S > 32 ? (0, e.rotlBL)(k, y, S) : (0, e.rotlSL)(k, y, S));
  function v(k, y = 24) {
    const S = new Uint32Array(10);
    for (let M = 24 - y; M < 24; M++) {
      for (let p = 0; p < 10; p++)
        S[p] = k[p] ^ k[p + 10] ^ k[p + 20] ^ k[p + 30] ^ k[p + 40];
      for (let p = 0; p < 10; p += 2) {
        const c = (p + 8) % 10,
          ...
          N = h(_, x, 1) ^ S[c],
          j = I(_, x, 1) ^ S[c + 1];
        for (let Q = 0; Q < 50; Q += 10) (k[p + Q] ^= N), (k[p + Q + 1] ^= j);
      }
      let T = k[2],
        b = k[3];
      for (let p = 0; p < 24; p++) {
        const c = r[p],
          ...
          _ = I(T, b, c),
          x = s[p];
        (T = k[x]), (b = k[x + 1]), (k[x] = w), (k[x + 1] = _);
      }
      for (let p = 0; p < 50; p += 10) {
        for (let c = 0; c < 10; c++) S[c] = k[p + c];
        for (let c = 0; c < 10; c++)
          k[p + c] ^= ~S[(c + 2) % 10] & S[(c + 4) % 10];
      }
      (k[0] ^= u[M]), (k[1] ^= d[M]);
    }
    S.fill(0);
  ...
  class A extends n.Hash {
    ...
    update(y) {
      ...
      const T = y.length;
      for (let b = 0; b < T; ) {
        const p = Math.min(S - this.pos, T - b);
        for (let c = 0; c < p; c++) M[this.pos++] ^= y[b++];
    ...
    finish() {
      ...
      this.finished = !0;
      const { state: y, suffix: S, pos: M, blockLen: T } = this;
      (y[M] ^= S),
    ...
    writeInto(y) {
      (0, t.aexists)(this, !1), (0, t.abytes)(y), this.finish();
      const S = this.state,
        { blockLen: M } = this;
      for (let T = 0, b = y.length; T < b; ) {
        this.posOut >= M && this.keccak();
        const p = Math.min(M - this.posOut, b - T);
        y.set(S.subarray(this.posOut, this.posOut + p), T),
          (this.posOut += p),
          (T += p);
      }
      return y;
    ...
    xof(y) {
      return (0, t.anumber)(y), this.xofInto(new Uint8Array(y));
    }
    digestInto(y) {
      if (((0, t.aoutput)(y, this), this.finished))
    ...
    _cloneInto(y) {
      ...
      return (
        y || (y = new A(S, M, T, p, b)),
        y.state32.set(this.state32),
        (y.pos = this.pos),
        (y.posOut = this.posOut),
        (y.finished = this.finished),
        (y.rounds = b),
        (y.suffix = M),
        (y.outputLen = T),
        (y.enableXOF = p),
        (y.destroyed = this.destroyed),
        y
      );
    }
  }
  O.Keccak = A;
  const L = (k, y, S) => (0, n.wrapConstructor)(() => new A(y, k, S));
  (O.sha3_224 = L(6, 144, 224 / 8)),
    (O.sha3_256 = L(6, 136, 256 / 8)),
    (O.sha3_384 = L(6, 104, 384 / 8)),
    (O.sha3_512 = L(6, 72, 512 / 8)),
    (O.keccak_224 = L(1, 144, 224 / 8)),
    (O.keccak_256 = L(1, 136, 256 / 8)),
    (O.keccak_384 = L(1, 104, 384 / 8)),
    (O.keccak_512 = L(1, 72, 512 / 8));
  const P = (k, y, S) =>
    (0, n.wrapXOFConstructorWithOpts)(
      (M = {}) => new A(y, k, M.dkLen === void 0 ? S : M.dkLen, !0)
    );
  return (
...
function kt() {
  if (Ge) return we;
  Ge = 1;
  const { keccak_256: t } = bn();
  function e(d) {
    return Buffer.allocUnsafe(d).fill(0);
  }
  function n(d) {
  ...
  function s(d, h) {
    let I = d.toString(16);
    I.length % 2 !== 0 && (I = "0" + I);
    const v = I.match(/.{1,2}/g).map((A) => parseInt(A, 16));
  ...
  function o(d) {
    if (!Buffer.isBuffer(d))
      if (Array.isArray(d)) d = Buffer.from(d);
        ...
        g(d) ? (d = Buffer.from(m(u(d)), "hex")) : (d = Buffer.from(d));
      else if (typeof d == "number") d = intToBuffer(d);
      else if (d == null) d = Buffer.allocUnsafe(0);
      else if (typeof d == "bigint") d = s(d);
      else if (d.toArray) d = Buffer.from(d.toArray());
      else throw new Error("invalid type");
    return d;
  }
  function l(d) {
    return (d = o(d)), "0x" + d.toString("hex");
  }
  function f(d, h) {
    if (((d = o(d)), h || (h = 256), h !== 256)) throw new Error("unsupported");
    return Buffer.from(t(new Uint8Array(d)));
  }
  function m(d) {
...
function wn() {
  ...
  function i(u) {
    var d = typeof u;
    if (d === "string" || d === "number") return BigInt(u);
    if (d === "bigint") return u;
    throw new Error("Argument is not a number");
  }
  function a(u, d) {
    var h, I, v, A;
    if (u === "address") return a("uint160", i(d));
    if (u === "bool") return a("uint8", d ? 1 : 0);
    if (u === "string") return a("bytes", new Buffer(d, "utf8"));
    if (l(u)) {
      if (typeof d.length > "u") throw new Error("Not an array?");
      ...
      for (A in d) v.push(a(u, d[A]));
      if (h === "dynamic") {
        var L = a("uint256", d.length);
        v.unshift(L);
      }
      ...
      if (u === "bytes")
        return (
          (d = new Buffer(d)),
          (v = Buffer.concat([a("uint256", d.length), d])),
          d.length % 32 !== 0 &&
            (v = Buffer.concat([v, t.zeros(32 - (d.length % 32))])),
          v
        );
      if (u.startsWith("bytes")) {
        ...
        const k = t.twosFromBigInt(I, 256);
        return t.bufferBEFromBigInt(k, 32);
      } else if (u.startsWith("ufixed")) {
        if (((h = s(u)), (I = i(d)), I < 0))
          throw new Error("Supplied ufixed is negative");
        return a("uint256", I * BigInt(2) ** BigInt(h[1]));
  ...
  function f(u, d) {
    ...
    for (var A in u) {
      var L = e(u[A]),
        P = d[A],
        k = a(L, P);
      o(L) ? (h.push(a("uint256", v)), I.push(k), (v += k.length)) : h.push(k);
    }
    return Buffer.concat(h.concat(I));
  }
  function m(u, d) {
    if (u.length !== d.length)
      throw new Error("Number of types are not matching the values");
    for (var h, I, v = [], A = 0; A < u.length; A++) {
      var L = e(u[A]),
        P = d[A];
      if (L === "bytes") v.push(P);
      else if (L === "string") v.push(new Buffer(P, "utf8"));
      else if (L === "bool") v.push(new Buffer(P ? "01" : "00", "hex"));
      else if (L === "address") v.push(t.setLength(P, 20));
        ...
        if (((h = n(L)), h % 8 || h < 8 || h > 256))
          throw new Error("Invalid uint<N> width: " + h);
        I = i(P);
        const k = t.bitLengthFromBigInt(I);
        if (k > h)
          throw new Error("Supplied uint exceeds width: " + h + " vs " + k);
        v.push(t.bufferBEFromBigInt(I, h / 8));
        ...
        const y = t.twosFromBigInt(I, h);
        v.push(t.bufferBEFromBigInt(y, h / 8));
      } else throw new Error("Unsupported or invalid type: " + L);
    }
    return Buffer.concat(v);
  }
  function g(u, d) {
  ...
  return (ye = { rawEncode: f, solidityPack: m, soliditySHA3: g }), ye;
}
var me, Ve;
function yn() {
  if (Ve) return me;
  ...
  const t = kt(),
    ...
    s = {
        ...
        if (l) {
          const g = (u, d, h) => {
            ...
            if (d.lastIndexOf("]") === d.length - 1) {
              const I = d.slice(0, d.lastIndexOf("[")),
                v = h.map((A) => g(u, I, A));
              return [
                "bytes32",
                t.keccak(
          ...
          for (const u of o[i]) {
            const [d, h] = g(u.name, u.type, a[u.name]);
            f.push(d), m.push(h);
          }
        } else
          for (const g of o[i]) {
            ...
            if (u !== void 0)
              if (g.type === "bytes")
                ...
                f.push("bytes32"),
                  ...
                  (u = t.keccak(u)),
                  m.push(u);
              else if (o[g.type] !== void 0)
                f.push("bytes32"),
                  (u = t.keccak(this.encodeData(g.type, u, o, l))),
                  m.push(u);
              else {
      ...
      encodeType(i, a) {
        ...
        for (const f of l) {
          ...
          o +=
            f +
            "(" +
            a[f].map(({ name: g, type: u }) => u + " " + g).join(",") +
            ")";
        }
        return o;
      },
      findTypeDependencies(i, a, o = []) {
        ...
        o.push(i);
        for (const l of a[i])
          for (const f of this.findTypeDependencies(l.type, a, o))
            !o.includes(f) && o.push(f);
        return o;
      },
      hashStruct(i, a, o, l = !0) {
        return t.keccak(this.encodeData(i, a, o, l));
      },
      hashType(i, a) {
      ...
      sanitizeData(i) {
        const a = {};
        for (const o in n.properties) i[o] && (a[o] = i[o]);
        return (
          a.types && (a.types = Object.assign({ EIP712Domain: [] }, a.types)), a
        );
      },
      hash(i, a = !0) {
        const o = this.sanitizeData(i),
          l = [Buffer.from("1901", "hex")];
        return (
          l.push(this.hashStruct("EIP712Domain", o.domain, o.types, a)),
          o.primaryType !== "EIP712Domain" &&
            l.push(this.hashStruct(o.primaryType, o.message, o.types, a)),
...
class En {
  ...
  async encrypt(e) {
    ...
    const s = crypto.getRandomValues(new Uint8Array(12)),
      r = await crypto.subtle.importKey("raw", de(n), { name: "aes-gcm" }, !1, [
        "encrypt",
        "decrypt",
      ]),
      i = new TextEncoder(),
      ...
      o = 16,
      l = a.slice(a.byteLength - o),
      f = a.slice(0, a.byteLength - o),
      m = new Uint8Array(l),
      g = new Uint8Array(f),
      u = new Uint8Array([...s, ...m, ...g]);
    return Ae(u);
  }
  async decrypt(e) {
    const n = this.secret;
    ...
    return new Promise((s, r) => {
      (async function () {
        ...
        try {
          const u = await window.crypto.subtle.decrypt(g, i, m),
            d = new TextDecoder();
          s(d.decode(u));
        } catch (u) {
          r(u);
...
class xn {
  constructor({ session: e, linkAPIUrl: n, listener: s }) {
    (this.destroyed = !1),
      ...
      (this.handleMetadataUpdated = async (i, a) => {
        ...
        (o = this.listener) === null || o === void 0 || o.metadataUpdated(i, l);
      }),
      (this.handleWalletUsernameUpdated = async (i) => {
        this.handleMetadataUpdated(kn, i);
      }),
      (this.handleAppVersionUpdated = async (i) => {
        this.handleMetadataUpdated(vn, i);
      }),
      (this.handleChainUpdated = async (i, a) => {
        var o;
        const l = await this.cipher.decrypt(i),
          f = await this.cipher.decrypt(a);
        (o = this.listener) === null || o === void 0 || o.chainUpdated(l, f);
      }),
      (this.session = e),
      (this.cipher = new En(e.secret)),
      (this.listener = s);
    const r = new Sn(`${n}/rpc`, WebSocket);
  ...
  heartbeat() {
    if (Date.now() - this.lastHeartbeatResponse > $e * 2) {
      this.ws.disconnect();
      return;
    }
    try {
  ...
  async makeRequest(e, n = { timeout: _n }) {
    const s = e.id;
    this.sendData(e);
    let r;
    return Promise.race([
...
class ee {
  constructor(e, n, s, r = !1) {
    (this.storage = e),
      (this.id = n),
      (this.secret = s),
      (this.key = Ot(zt(`${n}, ${s} WalletLink`))),
      (this._linked = !!r);
  }
  static create(e) {
    const n = Z(16),
      s = Z(32);
    return new ee(e, n, s).save();
  }
  static load(e) {
    const n = e.getItem(Je),
      s = e.getItem(Ze),
      r = e.getItem(Qe);
    return n && r ? new ee(e, n, r, s === "1") : null;
  }
  get linked() {
    return this._linked;
  }
  ...
  save() {
    return (
      this.storage.setItem(Je, this.id),
      this.storage.setItem(Qe, this.secret),
      this.persistLinked(),
      this
    );
  }
  persistLinked() {
    this.storage.setItem(Ze, this._linked ? "1" : "0");
  }
}
function An() {
  try {
...
function Et() {
  ...
  (t.type = "text/css"),
    t.appendChild(document.createTextNode(Rn)),
...
const It = (t) =>
  ...
  Dn = ({ autoExpand: t, message: e, menuItems: n }) => {
    const [s, r] = Te(!0),
      [i, a] = Te(t ?? !1);
    Mt(() => {
      const l = [
    ...
    return R(
      ...
      R(
        ...
        R("img", { src: Tn, class: "-cbwsdk-snackbar-instance-header-cblogo" }),
        " ",
        ...
        R(
          ...
          R("img", { src: On, class: "-gear-icon", title: "Expand" })
        )
      ),
      n &&
        n.length > 0 &&
...
class Un {
  constructor() {
    (this.attached = !1), (this.snackbar = new Nn());
  }
  attach() {
    if (this.attached)
...
class Bn {
  constructor() {
    (this.root = null), (this.darkMode = vt());
  }
  attach() {
    const e = document.documentElement;
    (this.root = document.createElement("div")),
...
const Wn = ({
    ...
    return R(
      ...
      R(
        ...
        R(
          "div",
          { class: se("-cbwsdk-redirect-dialog-box", i) },
          R("p", null, t),
  ...
  qn = "https://keys.coinbase.com/connect",
  Hn = "http://rpc.wallet.coinbase.com",
  Xe = "https://www.walletlink.org",
  Kn = "https://go.cb-w.com/walletlink";
class et {
  constructor() {
    (this.attached = !1), (this.redirectDialog = new Bn());
  }
  attach() {
    if (this.attached)
      throw new Error("Coinbase Wallet SDK UI is already attached");
  ...
  redirectToCoinbaseWallet(e) {
    const n = new URL(Kn);
    n.searchParams.append("redirect_url", Ln().href),
...
class z {
  constructor(e) {
    (this.chainCallbackParams = { chainId: "", jsonRpcUrl: "" }),
      ...
      (this.linkedUpdated = (i) => {
        this.isLinked = i;
        const a = this.storage.getItem(Se);
        if (
      ...
      (this.accountUpdated = (i) => {
        this.accountsCallback && this.accountsCallback([i]),
          z.accountRequestCallbackIds.size > 0 &&
            (Array.from(z.accountRequestCallbackIds.values()).forEach((a) => {
  ...
  subscribe() {
    const e = ee.load(this.storage) || ee.create(this.storage),
      { linkAPIUrl: n } = this,
      s = new xn({ session: e, linkAPIUrl: n, listener: this }),
      r = this.isMobileWeb ? new et() : new Un();
  ...
  resetAndReload() {
    this.connection
      .destroy()
      .then(() => {
        const e = ee.load(this.storage);
        (e == null ? void 0 : e.id) === this._session.id && H.clearAll(),
  ...
  signEthereumTransaction(e) {
    return this.sendRequest({
      ...
      params: {
        ...
        weiValue: q(e.weiValue),
        data: ie(e.data, !0),
        nonce: e.nonce,
        gasPriceInWei: e.gasPriceInWei ? q(e.gasPriceInWei) : null,
        maxFeePerGas: e.gasPriceInWei ? q(e.gasPriceInWei) : null,
        maxPriorityFeePerGas: e.gasPriceInWei ? q(e.gasPriceInWei) : null,
        gasLimit: e.gasLimit ? q(e.gasLimit) : null,
        chainId: e.chainId,
        shouldSubmit: !1,
      },
    });
  ...
  signAndSubmitEthereumTransaction(e) {
    return this.sendRequest({
      ...
      params: {
        ...
        nonce: e.nonce,
        gasPriceInWei: e.gasPriceInWei ? q(e.gasPriceInWei) : null,
        maxFeePerGas: e.maxFeePerGas ? q(e.maxFeePerGas) : null,
        maxPriorityFeePerGas: e.maxPriorityFeePerGas
          ? q(e.maxPriorityFeePerGas)
          : null,
        gasLimit: e.gasLimit ? q(e.gasLimit) : null,
        chainId: e.chainId,
        shouldSubmit: !0,
  ...
  submitEthereumTransaction(e, n) {
    return this.sendRequest({
      ...
      params: { signedTransaction: ie(e, !0), chainId: n },
    });
  }
    ...
    return new Promise((i, a) => {
      (n = this.ui.showConnecting({
        ...
        this.relayEventManager.callbacks.set(s, (o) => {
          if ((n == null || n(), U(o))) return a(new Error(o.errorMessage));
          i(o);
        }),
  ...
  handleWeb3ResponseMessage(e, n) {
    if (n.method === "requestEthereumAccounts") {
      z.accountRequestCallbackIds.forEach((s) => this.invokeCallback(s, n)),
        z.accountRequestCallbackIds.clear();
      return;
    }
  ...
  requestEthereumAccounts() {
    ...
    return new Promise((i, a) => {
      this.relayEventManager.callbacks.set(r, (o) => {
        if (U(o)) return a(new Error(o.errorMessage));
        i(o);
      }),
        z.accountRequestCallbackIds.add(r),
    ...
    const f = Z(8),
      m = (g) => {
        this.publishWeb3RequestCanceledEvent(f),
          this.handleErrorResponse(f, o.method, g),
          l == null || l();
      };
    return (
      ...
      new Promise((g, u) => {
        this.relayEventManager.callbacks.set(f, (d) => {
          if ((l == null || l(), U(d))) return u(new Error(d.errorMessage));
          g(d);
        }),
          this.publishWeb3RequestEvent(f, o);
      })
    );
  }
    ...
    return (
      ...
      new Promise((o, l) => {
        this.relayEventManager.callbacks.set(i, (f) => {
          ...
          if (U(f)) return l(new Error(f.errorMessage));
          o(f);
        }),
...
z.accountRequestCallbackIds = new Set();
const tt = "DefaultChainId",
  nt = "DefaultJsonRpcUrl";
class St {
  constructor(e) {
    (this._relay = null),
      (this._addresses = []),
      (this.metadata = e.metadata),
      (this._storage = new H("walletlink", Xe)),
      (this.callback = e.callback || null);
    const n = this._storage.getItem(Se);
    if (n) {
      const s = n.split(" ");
  ...
  get jsonRpcUrl() {
    var e;
    return (e = this._storage.getItem(nt)) !== null && e !== void 0
      ? e
      : void 0;
  }
  set jsonRpcUrl(e) {
    this._storage.setItem(nt, e);
  }
  updateProviderInfo(e, n) {
    var s;
    this.jsonRpcUrl = e;
    const r = this.getChainId();
    this._storage.setItem(tt, n.toString(10)),
      re(n) !== r &&
        ((s = this.callback) === null ||
          s === void 0 ||
          s.call(this, "chainChanged", J(n)));
  }
  async watchAsset(e) {
    const n = Array.isArray(e) ? e[0] : e;
    if (!n.type) throw C.rpc.invalidParams("Type is required");
  ...
  async addEthereumChain(e) {
    ...
    const a = this.initializeRelay(),
      ...
      u = await a.addEthereumChain(i.toString(), o, m, l, f, g);
    if (U(u)) return !1;
    if (
  ...
  _setAddresses(e, n) {
    ...
    JSON.stringify(r) !== JSON.stringify(this._addresses) &&
      ...
      this._storage.setItem(Se, r.join(" ")));
  }
  async request(e) {
    const n = e.params || [];
    switch (e.method) {
      ...
      default:
        if (!this.jsonRpcUrl) throw C.rpc.internal("No RPC URL set for chain");
        return Re(e, this.jsonRpcUrl);
    }
  }
  ...
  _prepareTransactionParams(e) {
    ...
    const s = e.to ? V(e.to) : null,
      r = e.value != null ? te(e.value) : BigInt(0),
      i = e.data ? Ie(e.data) : Buffer.alloc(0),
      a = e.nonce != null ? re(e.nonce) : null,
      o = e.gasPrice != null ? te(e.gasPrice) : null,
      l = e.maxFeePerGas != null ? te(e.maxFeePerGas) : null,
      f = e.maxPriorityFeePerGas != null ? te(e.maxPriorityFeePerGas) : null,
      m = e.gas != null ? te(e.gas) : null,
      g = e.chainId ? re(e.chainId) : this.getChainId();
    return {
      fromAddress: n,
      toAddress: s,
      weiValue: r,
  ...
  async ecRecover(e) {
    ...
    if (!Array.isArray(s)) throw C.rpc.invalidParams();
  ...
  getChainId() {
    ...
    return Number.parseInt(
      (e = this._storage.getItem(tt)) !== null && e !== void 0 ? e : "1",
      10
    );
  }
  async _eth_requestAccounts() {
    ...
    if (this._addresses.length > 0)
      return (
        (e = this.callback) === null ||
          e === void 0 ||
          e.call(this, "connect", { chainId: J(this.getChainId()) }),
        this._addresses
      );
    ...
    return (
      ...
      (n = this.callback) === null ||
        n === void 0 ||
        n.call(this, "connect", { chainId: J(this.getChainId()) }),
      this._addresses
    );
  }
...
const _t = "SignerType",
  xt = new H("CBWSDK", "SignerConfigurator");
function zn() {
  return xt.getItem(_t);
}
function Fn(t) {
  xt.setItem(_t, t);
}
...
function Yn(t) {
  ...
  switch (e) {
    case "scw":
      return new hn({ metadata: n, callback: r, communicator: s });
    case "walletlink":
      return new St({ metadata: n, callback: r });
  }
}
async function Vn(t, e, n) {
  await t.onMessage(({ event: r }) => r === "WalletLinkSessionRequest");
  const s = new St({ metadata: e, callback: n });
  t.postMessage({
...
const $n = `Coinbase Wallet SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Coinbase Smart Wallet app.
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
    ...
    return {
      ...
      checkCrossOriginOpenerPolicy: async () => {
        ...
        try {
          ...
          (t = s ?? "null"), t === "same-origin" && console.error($n);
        } catch (e) {
          console.error(
  ...
  { checkCrossOriginOpenerPolicy: Qn, getCrossOriginOpenerPolicy: Zn } = Jn(),
  st = 420,
  it = 540;
function Xn(t) {
  const e = (window.innerWidth - st) / 2 + window.screenX,
    n = (window.innerHeight - it) / 2 + window.screenY;
  ts(t);
  const s = `wallet_${crypto.randomUUID()}`,
    r = window.open(t, s, `width=${st}, height=${it}, left=${e}, top=${n}`);
  if ((r == null || r.focus(), !r))
    throw C.rpc.internal("Pop up window failed to open");
  return r;
}
function es(t) {
  t && !t.closed && t.close();
...
class ns {
  constructor({ url: e = qn, metadata: n, preference: s }) {
    (this.popup = null),
      ...
      (this.disconnect = () => {
        es(this.popup),
          ...
          this.listeners.forEach(({ reject: r }, i) => {
            r(C.provider.userRejectedRequest("Request rejected")),
...
function ss(t) {
  const e = Yt(is(t), { shouldIncludeStack: !0 }),
    n = new URL("https://docs.cloud.coinbase.com/wallet-sdk/docs/errors");
  return (
    n.searchParams.set("version", oe),
...
class os extends rs {
  constructor(e) {
    ...
    super(),
      ...
      (this.metadata = n),
      (this.preference = i),
      (this.communicator = new ns({ url: r, metadata: n, preference: i }));
    const a = zn();
        ...
        switch (e.method) {
          case "eth_requestAccounts": {
            const n = await this.requestSignerSelection(e),
              s = this.initSigner(n);
            await s.handshake(e), (this.signer = s), Fn(n);
            break;
          }
          case "wallet_sendCalls": {
...
function ds(t) {
  ...
  return (e = ln(n)) !== null && e !== void 0 ? e : new os(n);
}
const ls = { options: "all" };
function fs(t) {
  var e;
  new H("CBWSDK").setItem("VERSION", oe), Qn();
  const s = {
    metadata: {
  ...
  cs(s.preference);
  let r = null;
  return { getProvider: () => (r || (r = ds(s)), r) };
}
export { fs as createCoinbaseWalletSDK };
