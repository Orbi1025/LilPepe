...
import { n as z, c as we } from "./if-defined-ByrZyKqn.js";
          ...
          (o.getPenaltyN1 = function (t) {
            ...
            for (let A = 0; A < e; A++) {
              ...
              for (let C = 0; C < e; C++) {
                ...
                h === c
                  ? a++
                  : (a >= 5 && (s += r.N1 + (a - 5)), (c = h), (a = 1)),
                  (h = t.get(C, A)),
                  h === m
                    ? u++
                    : (u >= 5 && (s += r.N1 + (u - 5)), (m = h), (u = 1));
              }
  ...
  return (
    Ht ||
      ...
      (function (o) {
        ...
        function u(C, h, S) {
          for (let w = 1; w <= 40; w++)
            if (h <= o.getCapacity(w, S, C)) return w;
        }
        function c(C, h) {
        ...
        function A(C, h) {
          for (let S = 1; S <= 40; S++)
            if (m(C, S) <= o.getCapacity(S, h, t.MIXED)) return S;
        }
        (o.from = function (h, S) {
...
function Me() {
  ...
  return (
    ...
    (r.prototype.write = function (n) {
      ...
      a > 0 &&
        ((e = this.data.substr(t)), (s = parseInt(e, 10)), n.put(s, a * 3 + 1));
    }),
    (mt = r),
    mt
  );
      ...
      (pt = function (r) {
        for (var i = [], n = r.length, t = 0; t < n; t++) {
          ...
          if (e >= 55296 && e <= 56319 && n > t + 1) {
            ...
            s >= 56320 &&
              s <= 57343 &&
              ((e = (e - 55296) * 1024 + s - 56320 + 65536), (t += 1));
          }
          if (e < 128) {
            i.push(e);
            continue;
        ...
        var r = {
          ...
          PriorityQueue: {
            make: function (i) {
              ...
              return (
                (t.queue = []), (t.sorter = i.sorter || n.default_sorter), t
              );
            },
...
function _e() {
      ...
      (function (o) {
        ...
        function h(d) {
          return d.reduce(function (f, g) {
            ...
            return l && l.mode === g.mode
              ? ((f[f.length - 1].data += g.data), f)
              : (f.push(g), f);
          }, []);
        }
        function S(d) {
            ...
            for (let p = 0; p < N.length; p++) {
              ...
              for (let b = 0; b < P.length; b++) {
                ...
                g[B] && g[B].node.mode === M.mode
                  ? ((l[B][E] =
                      C(g[B].lastCount + M.length, M.mode) -
                      C(g[B].lastCount, M.mode)),
                    (g[B].lastCount += M.length))
                  : (g[B] && (g[B].lastCount = M.length),
                    (l[B][E] =
                      C(M.length, M.mode) +
                      4 +
                      r.getCharCountIndicator(M.mode, f)));
              }
            }
            P = R;
          }
 ...
 Suggested mode is: ` +
          ...
          switch (
            (g === r.KANJI && !a.isKanjiModeEnabled() && (g = r.BYTE), g)
          ) {
            case r.NUMERIC:
              return new i(d);
            case r.ALPHANUMERIC:
...
function qe() {
  ...
  function g(y, N, R) {
    ...
    R.forEach(function (T) {
      p.put(T.mode.bit, 4),
        p.put(T.getLength(), A.getCharCountIndicator(T.mode, y)),
        T.write(p);
    });
    const M = o.getSymbolTotalCodewords(y),
      ...
      b = (M - E) * 8;
    for (
      p.getLengthInBits() + 4 <= b && p.put(0, 4);
  ...
  function l(y, N, R) {
    ...
    let Mt = 0,
      ...
      _;
    for (D = 0; D < W; D++)
      for (_ = 0; _ < b; _++) D < Y[_].length && (X[Mt++] = Y[_][D]);
...
function Oe(o, r) {
  ...
  return i.reduce(
    (t, e, s) => (s % n === 0 ? t.push([e]) : t[t.length - 1].push(e)) && t,
    []
  );
}
const Ke = {
...
var U = function (o, r, i, n) {
  var t = arguments.length,
    e =
      t < 3 ? r : n === null ? (n = Object.getOwnPropertyDescriptor(r, i)) : n,
    s;
...
let v = class extends me {
  ...
  templateVisual() {
    return this.imageSrc
      ? j`<wui-image src=${this.imageSrc} alt=${
          this.alt ?? "logo"
        }></wui-image>`
      : this.farcaster
      ? j`<wui-icon
