...
import { e as B, n as O } from "./ref-B7eLNx1F.js";
import { n as G, s as J } from "./ConstantsUtil-Dmg8YACJ.js";
import "./index-C_7cPqFl.js";
import { S as Q } from "./index-BFQVdj8N.js";
...
`;
var I = function (s, e, i, n) {
  var r = arguments.length,
    t =
      r < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, i)) : n,
    o;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    t = Reflect.decorate(s, e, i, n);
  else
    for (var a = s.length - 1; a >= 0; a--)
      (o = s[a]) && (t = (r < 3 ? o(t) : r > 3 ? o(e, i, t) : o(e, i)) || t);
...
let C = class extends w {
  constructor() {
    super(...arguments),
      ...
      (this.instructionElementRef = B()),
      (this.instructionHidden = !!this.value),
      (this.pasting = !1),
      (this.onDebouncedSearch = D.debounce(async (e) => {
        const i = await H.getEnsAddress(e);
        if ((l.setLoading(!1), i)) {
          l.setReceiverProfileName(e), l.setReceiverAddress(i);
...
C.styles = X;
I([d()], C.prototype, "value", void 0);
I([c()], C.prototype, "instructionHidden", void 0);
I([c()], C.prototype, "pasting", void 0);
C = I([m("w3m-input-address")], C);
const Z = f`
  :host {
    position: relative;
...
A.styles = [z, W, Z];
E([d({ type: Boolean })], A.prototype, "disabled", void 0);
E([d({ type: String })], A.prototype, "value", void 0);
E([d({ type: String })], A.prototype, "placeholder", void 0);
A = E([m("wui-input-amount")], A);
const ee = f`
  :host {
    width: 100%;
    height: 100px;
  ...
  sendValueTemplate() {
    if (this.token && this.sendTokenAmount) {
      ...
      return u`<wui-text class="totalValue" variant="small-400" color="fg-200"
        >${
          i ? `$${x.formatNumberToLocalString(i, 2)}` : "Incorrect value"
        }</wui-text
      >`;
    }
    return null;
...
let h = class extends w {
  ...
  getMessage() {
    ...
    (this.message = "Preview Send"),
      this.receiverAddress &&
        !D.isAddress(this.receiverAddress, $.state.activeChain) &&
...
h.styles = te;
y([c()], h.prototype, "token", void 0);
y([c()], h.prototype, "sendTokenAmount", void 0);
y([c()], h.prototype, "receiverAddress", void 0);
y([c()], h.prototype, "receiverProfileName", void 0);
y([c()], h.prototype, "loading", void 0);
y([c()], h.prototype, "message", void 0);
h = y([m("w3m-wallet-send-view")], h);
const ie = f`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
let b = class extends w {
  constructor() {
    super(),
      ...
      (this.search = ""),
      (this.onDebouncedSearch = D.debounce((e) => {
        this.search = e;
      })),
      this.unsubscribe.push(
        l.subscribe((e) => {
      ...
      (this.tokens =
        (e = this.tokenBalances) == null
          ...
          : e.filter((n) => {
              ...
              return (
                n.chainId ===
                ((r = $.state.activeCaipNetwork) == null
                  ? void 0
                  : r.caipNetworkId)
              );
            })),
...
b.styles = ie;
P([c()], b.prototype, "tokenBalances", void 0);
P([c()], b.prototype, "tokens", void 0);
P([c()], b.prototype, "filteredTokens", void 0);
P([c()], b.prototype, "search", void 0);
b = P([m("w3m-wallet-send-select-token-view")], b);
const ne = f`
  :host {
    display: flex;
...
k.styles = [z, W, ne];
N([d()], k.prototype, "text", void 0);
N([d()], k.prototype, "address", void 0);
N([d()], k.prototype, "imageSrc", void 0);
N([d({ type: Boolean })], k.prototype, "isAddress", void 0);
k = N([m("wui-preview-item")], k);
const re = f`
  :host {
    display: flex;
  ...
  networkTemplate() {
    ...
    return (e = this.caipNetwork) != null && e.name
      ? u` <wui-list-content
        ...
        class="network"
        textTitle="Network"
        imageSrc=${K(L.getNetworkImage(this.caipNetwork))}
      ></wui-list-content>`
      : null;
  }
  onNetworkClick(e) {
...
let p = class extends w {
  constructor() {
    super(),
      ...
      (this.caipNetwork = $.state.activeCaipNetwork),
      (this.loading = l.state.loading),
      this.unsubscribe.push(
        l.subscribe((e) => {
          (this.token = e.token),
        ...
        $.subscribeKey("activeCaipNetwork", (e) => (this.caipNetwork = e))
      );
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
      ...
      <wui-flex gap="xs" flexDirection="column" .padding=${[
        ...
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${
              this.sendTokenAmount
                ? x.roundNumber(this.sendTokenAmount, 6, 5)
                : "unknown"
  ...
  async onSendClick() {
    ...
    try {
      await l.sendToken(),
        _.showSuccess("Transaction started"),
        g.replace("Account");
    } catch (r) {
      _.showError("Failed to send transaction. Please try again."),
        console.error(
          "SendController:sendToken - failed to send transaction",
          r
        );
      const t = $.state.activeChain,
      ...
      F.sendEvent({
        ...
        properties: {
          message: o,
          isSmartAccount:
            ((e = M.state.preferredAccountTypes) == null ? void 0 : e[t]) ===
            Y.ACCOUNT_TYPES.SMART_ACCOUNT,
          token: ((i = this.token) == null ? void 0 : i.symbol) || "",
          amount: this.sendTokenAmount,
          network:
            ((n = $.state.activeCaipNetwork) == null
              ? void 0
              : n.caipNetworkId) || "",
        },
      });
